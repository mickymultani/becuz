 ...
 * MCP-capable coding agent WHEN to call the becuz tools. `init` appends it to
 * CLAUDE.md (and prints it for pasting into Cursor rules, etc.).
 */
export const GUIDANCE_SNIPPET = `<!-- becuz:begin -->
...
export const GUIDANCE_BEGIN = "<!-- becuz:begin -->";
export const GUIDANCE_END = "<!-- becuz:end -->";
